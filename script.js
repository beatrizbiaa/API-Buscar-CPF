function valor() {
    //Função que carrega as informaçoes do JSON
    fetch('https://raw.githubusercontent.com/beatrizbiaa/minhaAPI/refs/heads/main/dados.json').then(resposta => resposta.json()).then(banco => {
